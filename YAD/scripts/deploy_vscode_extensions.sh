...
code --install-extension /opt/FedoraRemix/VSCode/asciidoctor.asciidoctor-vscode-3.3.1.vsix
...
code --install-extension /opt/FedoraRemix/VSCode/Codeium.codeium-1.17.11.vsix
