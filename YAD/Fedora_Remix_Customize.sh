...
--field="<b>Create SSH Key and Prepare Ansible</b>":fbtn "gnome-terminal -t 'Create SSH Key and Prepare Ansible' -- sh -c 'sudo /opt/FedoraRemix/scripts/create_ssh_key.sh'" \
